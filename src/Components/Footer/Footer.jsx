...
const Footer = () => {
  return (
    <div className="mx-auto container ">
      ...
      <footer className="footer  py-15 sm:footer-horizontal px-5 bg-[#101727] text-[#ffffff]  ">
        <nav>
          <h1 className="font-bold">DigitTools</h1>
          <p>
        ...
        <nav>
          ...
          <a className="link link-hover">Intregation</a>
        </nav>
        <nav>
      ...
      <div className=" flex justify-between sm:j my-10 py-5 px-5">
